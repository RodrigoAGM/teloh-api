...
var UserController = /** @class */ (function () {
    ...
    UserController.newUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var _a, username, password, role, email, age, firstName, lastName, bookingEnabled, user, errors, userRepository, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, username = _a.username, password = _a.password, role = _a.role, email = _a.email, age = _a.age, firstName = _a.firstName, lastName = _a.lastName, bookingEnabled = _a.bookingEnabled;
    ...
    UserController.editUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var id, _a, username, role, email, age, firstName, lastName, bookingEnabled, userRepository, user, error_2, errors, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
                    _a = req.body, username = _a.username, role = _a.role, email = _a.email, age = _a.age, firstName = _a.firstName, lastName = _a.lastName, bookingEnabled = _a.bookingEnabled;
                    userRepository = typeorm_1.getRepository(User_1.User);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
